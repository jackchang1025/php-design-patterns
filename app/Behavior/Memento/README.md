...
![image](./images/memento-zh-2x.png)

### 问题
假如你在开发一款文字编辑器应用程序，除了简单的文字编辑功能外，编辑器中还要有设置文本格式和插入内嵌图片功能
...
![image](./images/structure1-2x.png)
...
![image](./images/structure2-2x.png)
...
![image](./images/structure3-2x.png)
...
### 备忘录模式优缺点
* ✔️你可以在不破坏对象封装情况的前提下创建对象状态快照。
* ✔️你可以通过让负责人维护原发器状态历史记录来简化原发器代码。
